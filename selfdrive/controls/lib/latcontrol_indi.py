  ...
  def update(self, active, v_ego, angle_steers, angle_steers_rate, steer_override, CP, VM, path_plan):
    ...
    if v_ego < 0.3 or not active:
      ...
      if abs(self.angle_steers_des) < 3:
          ...
          self.RC = (self.timeConstant * 2.5)
      #self.G = interp(abs(self.angle_steers_des), [0, 3], [self.actuatorEffectiveness, (self.actuatorEffectiveness * 2)])
      #self.RC = interp(abs(self.angle_steers_des), [0, 3], [self.timeConstant, (self.timeConstant * 2.5)])
