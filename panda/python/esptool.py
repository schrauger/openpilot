...
# NB: Before sending a PR to change the above line to '#!/data/data/com.termux/files/usr/bin/env python2', please read https://github.com/themadinventor/esptool/issues/21
#
